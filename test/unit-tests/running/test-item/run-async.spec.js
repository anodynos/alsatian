...
var TestItemRunAsyncTests = /** @class */ (function () {
    function TestItemRunAsyncTests() {
    }
    TestItemRunAsyncTests.prototype.successfulAsyncTest = function () {
    ...
    TestItemRunAsyncTests.prototype.ignoreAsyncTest = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    TestItemRunAsyncTests.prototype.failAsyncTest = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    TestItemRunAsyncTests.prototype.errorAsyncTest = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    TestItemRunAsyncTests.prototype.testErrorAsyncTest = function () {
        return __awaiter(this, void 0, void 0, function () {
            var test, expectedError, testFixture, testItem, error, e_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        test = new test_builder_1.TestBuilder().withTestCaseCount(1).build();
    ...
    TestItemRunAsyncTests.prototype.timeoutAsyncTest = function (timeout) {
        return __awaiter(this, void 0, void 0, function () {
            var test, testFixture, testItem, error, e_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        test = new test_builder_1.TestBuilder().withTestCaseCount(1).build();
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, testItem.run(timeout)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    ], TestItemRunAsyncTests.prototype, "successfulAsyncTest", null);
    __decorate([
        alsatian_core_1.AsyncTest(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], TestItemRunAsyncTests.prototype, "ignoreAsyncTest", null);
    __decorate([
        alsatian_core_1.AsyncTest(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], TestItemRunAsyncTests.prototype, "failAsyncTest", null);
    __decorate([
        alsatian_core_1.AsyncTest(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], TestItemRunAsyncTests.prototype, "errorAsyncTest", null);
    __decorate([
        alsatian_core_1.AsyncTest(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], TestItemRunAsyncTests.prototype, "testErrorAsyncTest", null);
    __decorate([
        alsatian_core_1.TestCase(1),
        alsatian_core_1.TestCase(42),
        alsatian_core_1.TestCase(99),
        alsatian_core_1.AsyncTest(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Number]),
        __metadata("design:returntype", Promise)
    ], TestItemRunAsyncTests.prototype, "timeoutAsyncTest", null);
    return TestItemRunAsyncTests;
}());
exports.TestItemRunAsyncTests = TestItemRunAsyncTests;
//# sourceMappingURL=run-async.spec.js.map