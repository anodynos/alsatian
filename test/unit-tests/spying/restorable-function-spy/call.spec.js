...
var CallTests = /** @class */ (function () {
    ...
    CallTests.prototype.originalFunctionIsCalled = function () {
        var object = {
            originalFunction: function () { }
        };
    ...
    CallTests.prototype.originalFunctionNotCalledIfSpyStub = function () {
        var object = {
            originalFunction: function () { }
        };
        alsatian_core_1.SpyOn(object, "originalFunction");
    ...
    __decorate([
        ...
        __metadata("design:returntype", void 0)
    ], CallTests.prototype, "originalFunctionIsCalled", null);
    __decorate([
        alsatian_core_1.Test(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], CallTests.prototype, "originalFunctionNotCalledIfSpyStub", null);
    __decorate([
